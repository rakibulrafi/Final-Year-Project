...
if (! (isset ( $_SESSION ['login'] ))) {
  ...
  if(isset($_POST['submit'])){
	...
	$obj->create_result($_POST['course-short'],$_POST['course-full'],$_POST['semester'],$_POST['Sid'],$_POST['name'],$_POST['sub1'],$_POST['cgpa1'],
	                     $_POST['sub2'] ,$_POST['cgpa2'],$_POST['sub3'],$_POST['cgpa3'],$_POST['sub4'],$_POST['cgpa4'],
						 $_POST['sub5'],$_POST['cgpa5']
	                     );	
...
<div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                         <div class="col-lg-6">
			<th>&nbsp;&nbsp;&nbsp;&nbsp;Subject<span id="" style="font-size:11px;color:red">*</span>	</label></th>
			</div>   
              
              <div class="col-lg-6">
			 <th>&nbsp;&nbsp;&nbsp;&nbsp;Cgpa<span id="" style="font-size:11px;color:red">*</span></th>
			</div>                                 
            </tr>
                                    </thead>
                                    <tbody>
            ...
            <td><div class="col-lg-6">
			<input class="form-control"  type="text" name="cgpa1" >
			</div></td>
                  </tr>
              ...
              <tr> 
                  ...
                  <td><div class="col-lg-6">
			<input class="form-control" type="text" name="cgpa2" >
			</div></td>
...
<tr> 
                  ...
                  <td><div class="col-lg-6">
			<input class="form-control" type="text" name="cgpa3" >
			</div></td>
            
                  </tr> 
<tr> 
                  <td><div class="col-lg-6">
				  <input class="form-control" type="text" name="sub4" >
				  </div></td>
                  <td><div class="col-lg-6">
			<input class="form-control" type="text" name="cgpa4" >
			</div></td>
...
<tr> 
                  <td><div class="col-lg-6">
				  <input class="form-control" type="text" name="sub5" >
				  </div></td>
                  <td><div class="col-lg-6">
			<input class="form-control" type="text" name="cgpa5" >
			</div></td>
