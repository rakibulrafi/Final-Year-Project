...
if (! (isset ( $_SESSION ['login'] ))) {
  ...
  if(isset($_POST['submit'])){
	...
	$obj->create_subject($_POST['course-short'],$_POST['course-full'],$_POST['semester'],$_POST['sub1'],$_POST['sub2'],$_POST['sub3'],$_POST['sub4'],$_POST['sub5'],$_POST['sub6']);	
...
<div class="form-group">
		<div class="col-lg-4">
		<label>Subject1<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
...
<div class="form-group">
		<div class="col-lg-4">
		<label>Subject2<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
...
<div class="form-group">
		<div class="col-lg-4">
		<label>Subject3<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
...
<div class="form-group">
		<div class="col-lg-4">
		<label>Subject4<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
...
<div class="form-group">
		<div class="col-lg-4">
		<label>Subject5<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
...
<div class="form-group">
		<div class="col-lg-4">
		<label>Subject6<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
